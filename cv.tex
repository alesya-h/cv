...
Server technologies   & NixOps, Consul, Chef, Nginx, Apache httpd, \\
...
\begin{rSection}{Some facts to better understand what kind of person I am}
  ...
  \item I use NixOS with lots of handwritten scripts and a tiling window manager as my work environment. Before NixOS I used to use Archlinux.
  ...
  \item One of my primary interests is expressivity of programming languages. I have plans to get a PhD in that field.

...
\item Initiated using SCSS and Compass, which led to development speedup and stylesheets support simplification.
\item Configured production server from scratch for automated Capistrano deployment
\end{rSubsection}
